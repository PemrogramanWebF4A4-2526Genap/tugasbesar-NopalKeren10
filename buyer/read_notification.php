...
<head>
    ...
    <title>Notifikasi - BookStore</title>
   ...
   <nav class="bg-ink text-paper shadow-lg border-b-4 border-brass">
        <div class="container mx-auto flex justify-between items-center px-4 py-4">
            ...
            <div class="flex items-center space-x-3">
                <a href="index.php" class="border border-brass/60 hover:bg-brass hover:text-ink px-4 py-2 rounded-sm font-semibold transition text-sm">
                    Kembali Belanja
                </a>
    ...
    <main class="container mx-auto py-10 px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-card rounded-sm shadow-md p-6 border border-ink/5">
                ...
                <?php if (empty($notifications)): ?>
                    <div class="text-center py-16">
                        ...
                        <p class="text-ink/30 text-sm">Anda akan menerima notifikasi saat ada update pesanan atau ulasan baru</p>
                    </div>
                <?php else: ?>
                    <div class="space-y-3">
