...
('admin', 'admin@bookstore.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrator', 'admin', TRUE);

-- Insert sample categories
INSERT INTO categories (name, description) VALUES
('Fiksi', 'Buku-buku fiksi dan novel'),
('Non-Fiksi', 'Buku-buku non-fiksi dan fakta'),
('Sains', 'Buku-buku sains dan teknologi'),
('Sejarah', 'Buku-buku sejarah dan biografi'),
('Pendidikan', 'Buku-buku pendidikan dan pelajaran'),
('Anak', 'Buku-buku untuk anak-anak');
